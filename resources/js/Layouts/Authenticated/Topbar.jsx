        ...
        <div className="flex justify-between items-center cursor-pointer">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="collapsible-dropdown flex flex-col gap-2 relative">
                    ...
                    <div className="bg-slate-50 rounded-2xl text-black font-medium flex flex-col gap-1 absolute z-[999] right-0 top-[80px] min-w-[180px] hidden overflow-hidden"
                        ref={dropdownTarget}>
                        ...
                        <Link href={route('logout')} className="transition-all hover:bg-sky-100 p-4" method='post' as='button'>Sign Out</Link>
                    </div>
                </div>
            </div>
